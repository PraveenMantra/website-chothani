    ...
    <section className="relative overflow-hidden">
      <div className="relative hero">
        ...
        <div
          ...
          style={{ paddingTop: "calc(var(--spacing) * 82)" }}
          id="home"
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 items-start">
            ...
            <Reveal className="lg:col-span-5">
              <div
                className="w-full max-w-[460px] text-white rounded-2xl p-6 shadow-2xl backdrop-blur-[2px] mb-[35px] md:mb-0"
                style={{
                  background:
              ...
              >
                ...
                {/* Description */}
                <p
                  className="mt-4 text-[14px] sm:text-[16px] lg:text-[18px] leading-[1.4] font-semibold text-black rounded-md p-3 shadow-[inset_0_1px_3px_rgba(255,255,255,0.4),0_4px_10px_rgba(0,0,0,0.15)]"
                  style={{
                    background:
        ...
        >
          <div className="flex flex-col lg:flex-row items-center gap-10">
            {/* LEFT: Image (≈47%) — make this the LCP */}
            <Reveal className="w-full lg:w-[47%] flex justify-center lg:justify-start">
              <div className="relative w-full max-w-[640px]">
                <Image
                  ...
                  priority
                  fetchPriority="high"
                  loading="eager" // explicit; Next auto-sets for priority
            ...
            {/* RIGHT: Text (≈50%) */}
            <Reveal className="w-full lg:w-[50%]">
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0E3C14]">PROJECT OVERVIEW</h2>

              <p className="mt-4 text-[15px] leading-7 text-neutral-700">
                Introducing <b>27 Palazzo</b>, a landmark residential development by
                <b> Chothani BuildCorp Pvt. Ltd.</b> Located in Chembur East, this project blends
                architectural elegance, spacious design, and premium fittings to redefine modern urban living.
              </p>
