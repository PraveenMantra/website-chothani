// app/(components)/DisclaimerSection.tsx
...
export default function DisclaimerSection({
  ...
  return (
    <section
      className="relative bg-center bg-cover border-b border-black/10"
      style={{ backgroundImage: `url(${bgImage})` }}
    >
      {/* white strip at the bottom, so the badge can overlap the seam */}
      <div className="absolute inset-x-0 bottom-0 h-24 bg-white" aria-hidden />

      <div className="mx-auto w-full max-w-[1450px] px-4 sm:px-6 lg:px-8 pt-10 md:pt-14 lg:pt-16 pb-28 md:pb-32">
        {/* Heading */}
        <h2 className="text-center text-[#10410f] font-extrabold tracking-wide text-3xl sm:text-4xl md:text-5xl">
          DISCLAIMER
        </h2>
